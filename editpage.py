...
class Editpage(QMainWindow):
	...
	def setupUi(self):
		...
		self.ocrButton = self.findChild(QPushButton, "inpaint_button")
		...
		self.ocrButton.clicked.connect(self.recognizeTextFromImage)
		...
		# self.imageView.setPhoto(pixmap)								
		self.imageView.setPhoto(QPixmap(resource_path(os.path.join("resources","med.png"))))
		self.addTesseractConfig("Sentence")
		self.addTesseractConfig("Word")
	...
	def selectionChange(self):
		self.imageView.setTesseractConfig(self.chooseMethod.currentText())

	def addTesseractConfig(self, method):
	...
	def recognizeTextFromImage(self):
		self.imageView.recognizeText()
